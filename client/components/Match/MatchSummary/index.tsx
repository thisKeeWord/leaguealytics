            ...
            {[team100, team200].map((team, index) => (
              <div className={cx({ 'team-100': index === 0, 'team-200': index === 1 })} key={index}>
                <div className={cx('team-summary', { blue: index === 0, red: index === 1 })}>
                  <div className="game-conclusion">{adjustedTeams[index].win ? 'WIN' : 'LOSS'}</div>
                  <div className="gold">
                    <img className="label" src="../../../../images/gold.png" alt="gold" />
                    <span>{numberFormatter(adjustedTeams[index].goldEarned)}</span>
                  ...
                  return (
                    <div className={cx('match-summary', { team100: teamId === 100, team200: teamId === 200, currentUser: currentPlayer.summonerId === summonerId })} key={summonerName}>
                      ...
                      <div className="cs-gold">
                        <div className="cs">
                          <img src="../../../../images/minions.png" alt="cs" />
